...
This module provides enhanced versions of apptk containers that:
...
from apptk.layout.controls import DummyControl as PtkDummyControl
from apptk.layout.dimension import Dimension
from apptk.layout.margins import ClickableMargin, Margin
from apptk.layout.screen import _CHAR_CACHE, WritePosition
...
def distribute_dimensions(
    ...
    This is a cached version of apptk's dimension distribution logic that improves
...
class DummyContainer(Container):
    ...
    This is a more efficient version of apptk's DummyContainer that:
...
class HSplit(ptk_containers.HSplit):
    ...
    def write_to_screen(
        ...
        :param screen: The :class:`~apptk.layout.screen.Screen` class
...
class Window(ptk_containers.Window):
    ...
    def _register_graphics(
        ...
        """
        from apptk.layout.graphics import select_graphic_control
