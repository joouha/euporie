...
from apptk.key_binding.bindings.basic import load_basic_bindings
from apptk.key_binding.bindings.cpr import load_cpr_bindings
from apptk.key_binding.bindings.emacs import (
    load_emacs_bindings,
