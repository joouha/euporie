...
from apptk.filters.environment import in_screen, in_tmux
from apptk.filters.utils import to_filter
from apptk.output.color_depth import ColorDepth
from apptk.styles.base import DEFAULT_ATTRS
from apptk.utils import is_dumb_terminal
...
class Vt100_Output(PtkVt100_Output):
    ...
    def get_pixel_size(self) -> tuple[int, int]:
        ...
        try:
            ...
            from apptk.io import _tiocgwinsz
