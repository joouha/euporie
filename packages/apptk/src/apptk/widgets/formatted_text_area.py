...
from apptk.layout.margins import ConditionalMargin, NumberedMargin
from apptk.layout.processors import DynamicProcessor, Processor, Transformation
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            args: Arguments to pass to `apptk.widgets.TextArea`.
            line_numbers: Determines if line numbers are shown.
            kwargs: Key-word arguments to pass to `apptk.widgets.TextArea`.
