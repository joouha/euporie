...
.. glossary::
   ...
   Command
      ...
      registry. Commands can be invoked from the command palette, from a
      menu, from a toolbar, by pressing a key binding, or programmatically.
