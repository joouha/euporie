...
def build_style(
    ...
    style_dict = {
        ...
        **dict(default_ui_style().style_rules),
        ...
        "ipywidget button.selected button.border right": "fg:#ffffff",
        ...
        "ipywidget text-area text-area.border top invalid": "fg:ansidarkred",
        "ipywidget text-area text-area.border right invalid": "fg:ansired",
        "ipywidget text-area text-area.border bottom invalid": "fg:ansired",
        "ipywidget text-area text-area.border left invalid": "fg:ansidarkred",
        "ipywidget slider slider.track": f"fg:{cp.fg.darker(0.5)}",
        "ipywidget slider slider.track.selected": "fg:ansiblue",
        "ipywidget slider slider.arrow": f"fg:{cp.fg.darker(0.25)}",
        "ipywidget slider slider.handle": f"fg:{cp.fg.darker(0.25)}",
        "ipywidget slider slider.handle focused": "fg:white",
        "ipywidget slider slider.handle.selected": "",
        "ipywidget slider slider.handle.selected focused": "fg:ansiblue",
        ...
        "ipywidget progress progress.border": "bg:default",
        "ipywidget progress progress.border top": "fg:#606060",
