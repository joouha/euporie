...
def build_style(
    ...
    style_dict = {
        ...
        **dict(default_ui_style().style_rules),
        ...
        "ipywidget success border top": "fg:ansibrightgreen",
        "ipywidget success border left": "fg:ansibrightgreen",
        "ipywidget success border bottom": f"fg:{cp.ansigreen.darker(0.5)}",
        "ipywidget success border right": f"fg:{cp.ansigreen.darker(0.5)}",
        "ipywidget info border top": "fg:ansibrightcyan",
        "ipywidget info border left": "fg:ansibrightcyan",
        "ipywidget info border bottom": f"fg:{cp.ansicyan.darker(0.5)}",
        "ipywidget info border right": f"fg:{cp.ansicyan.darker(0.5)}",
        "ipywidget warning border top": "fg:ansibrightyellow",
        "ipywidget warning border left": "fg:ansibrightyellow",
        "ipywidget warning border bottom": f"fg:{cp.ansiyellow.darker(0.5)}",
        "ipywidget warning border right": f"fg:{cp.ansiyellow.darker(0.5)}",
        "ipywidget danger border top": "fg:ansibrightred",
        "ipywidget danger border left": "fg:ansibrightred",
        "ipywidget danger border bottom": f"fg:{cp.ansired.darker(0.5)}",
        "ipywidget danger border right": f"fg:{cp.ansired.darker(0.5)}",
        ## Selected styled borders
        "ipywidget selection success border top": f"fg:{cp.ansigreen.darker(0.5)}",
        "ipywidget selection success border left": f"fg:{cp.ansigreen.darker(0.5)}",
        "ipywidget selection success border bottom": "fg:ansibrightgreen",
        "ipywidget selection success border right": "fg:ansibrightgreen",
        "ipywidget selection info border left": f"fg:{cp.ansicyan.darker(0.5)}",
        "ipywidget selection info border top": f"fg:{cp.ansicyan.darker(0.5)}",
        "ipywidget selection info border right": "fg:ansibrightcyan",
        "ipywidget selection info border bottom": "fg:ansibrightcyan",
        "ipywidget selection warning border top": f"fg:{cp.ansiyellow.darker(0.5)}",
        "ipywidget selection warning border left": f"fg:{cp.ansiyellow.darker(0.5)}",
        "ipywidget selection warning border bottom": "fg:ansibrightyellow",
        "ipywidget selection warning border right": "fg:ansibrightyellow",
        "ipywidget selection danger border top": f"fg:{cp.ansired.darker(0.5)}",
        "ipywidget selection danger border left": f"fg:{cp.ansired.darker(0.5)}",
