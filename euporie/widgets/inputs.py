...
class Label:
    def __init__(self, value: "str", style: "str" = ""):
        self.value = value
...
class ToggleButtons(SelectMixin):
    def load_container(self) -> "AnyContainer":
    ...
    def update_buttons(self, widget: "Optional[ToggleButtons]" = None):
